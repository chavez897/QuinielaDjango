...
from quiniela.users.permissions.users import IsAdmin, IsManager
from quiniela.users.serializers.auth import (
...
class UserAuthViewSet(viewsets.GenericViewSet):
    ...
    def get_permissions(self):
        ...
        if self.action in ["invitation"]:
            permissions = [IsAuthenticated, IsAdmin | IsManager]
